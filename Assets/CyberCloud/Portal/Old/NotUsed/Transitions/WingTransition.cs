...
/// </summary>
public abstract class WingTransition : MonoBehaviour {
	
	protected WingTransitionState state = WingTransitionState.Out;
	...
	/// <summary>
	/// invoked during the <see cref="WingTransitionState.Hold"/> state to load the next scene. 
	...
	/// <summary>
	/// invoked at the start of the <see cref="WingTransitionState.In"/> and <see cref="WingTransitionState.Out"/> state to 
	...
	/// <summary>
	/// Invoked once per frame while the transition is in state <see cref="WingTransitionState.In"/> or <see cref="WingTransitionState.Out"/> 
