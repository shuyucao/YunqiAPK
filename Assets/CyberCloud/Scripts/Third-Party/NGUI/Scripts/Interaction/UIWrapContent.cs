...
public class UIWrapContent : MonoBehaviour
{
    ...
    public delegate void OnScrollEndItem();
    ...
    /// 滑动至底部时执行
    /// </summary>
    public OnScrollEndItem onScrollEndItem;
    ...
    public void WrapContent()
    {
        ...
        //Debug.LogError("this extents:"+ extents);
        ...
        {
            v(corners, center,  extents, ext2, allWithinRange);
        }
    }

    private void v(Vector3[] corners, Vector3 center, float extents, float ext2, bool allWithinRange)
    {
    ...
    protected virtual void UpdateItem(Transform item, int index)
    {
        if (onInitializeItem != null)
        {
            ...
            //Debug.LogError("ucvr :item.localPosition.y"+ item.localPosition.y+ ";itemSize:"+ itemSize);
