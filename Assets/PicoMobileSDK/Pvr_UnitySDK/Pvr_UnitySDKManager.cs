...
public class Pvr_UnitySDKManager : MonoBehaviour
{
    ...
    private void InitUI()
    {
        if (trackingmode > 1)
        {
            safeArea = Instantiate(Resources.Load("Prefabs/SafeArea2") as GameObject, transform, false);
        ...
        safePanel1 = Instantiate(Resources.Load("Prefabs/SafePanel1") as GameObject, transform, false);

        if (iPhoneHMDModeEnabled == 1)
        {
            var flamingo2Tips = Instantiate(Resources.Load("Prefabs/flamingo2Tips") as Transform, transform.Find("Head"), false);
    ...
    private void RefreshTextByLanguage()
    {
        if (Application.systemLanguage != SystemLanguage.Chinese && Application.systemLanguage != SystemLanguage.ChineseSimplified)
        {
            ...
            if (safePanel1 != null && resetPanel != null)
            {
